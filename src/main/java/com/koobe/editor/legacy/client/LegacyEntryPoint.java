package com.koobe.editor.legacy.client;
 ...
 * @author lyhcode
 */
public class LegacyEntryPoint implements EntryPoint, HistoryListener {

    interface Binder extends UiBinder<Widget, LegacyEntryPoint> {
    }
